...
class ext extends \phpbb\extension\base
{
	 ...
	 *
	 * Requires phpBB 3.3.0 due to usage of new exception classes.
	 *
	 * @return bool
	 * @aceess public
	 */
	...
	{
		return phpbb_version_compare(PHPBB_VERSION, '3.3.0', '>=') && phpbb_version_compare(PHP_VERSION, '7.0', '>=');
	}
}
